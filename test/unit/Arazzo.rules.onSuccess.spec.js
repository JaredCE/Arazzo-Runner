  ...
  describe(`onSuccess`, function () {
    describe(`end`, function () {
      describe(`step`, function () {
        it(`should end the workflow if the first step hits a onSuccess end rule at step level that matches`, async function () {
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/end/step/first-step.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
        ...
        it(`should end the workflow if the middle step hits a onSuccess end rule at step level that matches`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/end/step/middle-step.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
      ...
      describe(`workflow`, function () {
        it(`should end the workflow if the first step hits a successActions end rule at workflow level that matches`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/end/workflow/first-step.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
        ...
        it(`should end the workflow if the middle step hits a successActions end rule at workflow level that matches`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/end/workflow/middle-step.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
        ...
        it(`a step level onSuccess end rule should override a workflow level successActions rule`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/end/workflow/step-override.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
    ...
    describe(`goto`, function () {
      describe(`step`, function () {
        it(`should goto a different step if the first step hits a onSuccess goto rule at step level`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/goto/step/first-step-to-step.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
        ...
        it(`should goto a different workflow if the first step hits a onSuccess goto rule at step level`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/goto/step/first-step-to-workflow.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
        ...
        it(`should goto a different step if a middle step hits a onSuccess goto rule at step level`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/goto/step/middle-step-to-step.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
        ...
        it(`should goto a different workflow if a middle step hits a onSuccess goto rule at step level`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/goto/step/middle-step-to-worklfow.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
      ...
      describe(`workflow`, function () {
        it(`should goto a different step if the first step hits a successActions goto rule at workflow level`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/goto/workflow/first-step.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
        ...
        it(`a step level onSuccess goto rule should override a workflow level successActions rule`, async function () {
          nock("https://raw.githubusercontent.com:443", {
            encodedQueryParams: true,
          })
            .get(
          ...
          const arazzo = new Arazzo(
            "./test/mocks/arazzo/arazzo-rules/onSuccess/goto/workflow/step-override.json",
            "arazzo",
            { logger: logger },
            docFactory,
          );
